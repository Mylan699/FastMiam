        ...
        <div className='mt-5 relative'>
            <div className='flex gap-4 overflow-auto scrollbar-hide' ref={listRef}>
                {CategoryList && CategoryList.map((category, index) => (
                    <Link href={'?category='+category.slug} key={index} className={`flex flex-col items-center gap-2 border p-3 rounded-xl min-w-32 hover:border-primary hover:bg-orange-100 cursor-pointer group
